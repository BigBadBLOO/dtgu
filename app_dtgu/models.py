...
class ParamsMarks(models.Model):
    ...
    valueMin = models.TextField(max_length=500, blank=True, null=True, verbose_name="Пороговое значение")
    ...
    is_good = models.BooleanField(blank=True, null=True, verbose_name='Проходит ли по критериям')
